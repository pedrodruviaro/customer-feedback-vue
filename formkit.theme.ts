...
/**
  ...
  *
  * @checksum - 099574343a7388bcc4e445282171da9c609b56929e49a8d77e68ccfdc7f982b2
  * @variables - radius=rounded,accentColor=blue,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "submit__input": {
    ...
    "dark:ring-offset-zinc-500": true,
